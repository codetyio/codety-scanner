...
@SpringBootTest
public class StylelintCodeAnalyzerTest {

    @Autowired
    StylelintCodeAnalyzer stylelintCodeAnalyzer;
    ...
    void testScan(){
        ...
        List<CodeAnalysisResultDto> codeAnalysisResultDtos = stylelintCodeAnalyzer.analyzeCode(analyzerRequest);
